...
def get_content(
    ...
    try:
        ...
        # TODO: consider returning number of tokens?
        # if serve model no reason-parser, here is not message.reason or message.reason_content,
        # contextn includes </think>, you may need to clean
...
if __name__ == "__main__":
    ...
    res = get_content(user_input, base_url, model)
