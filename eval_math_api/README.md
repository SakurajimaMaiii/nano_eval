...
`eval/eval.py` only reports accuracy of `pass@1` over N repeat or `avg@N`. To get `major@N` or `pass@N`, use

```bash
python eval_major_pass.py --file_path ./eval_res/aime24_bz64.jsonl
```
